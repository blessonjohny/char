...
const ALL_BOT_AVATARS_6P = [
  ...
  {name:'Neha',emoji:heroAvatarHtml('hero3f4'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  ...
  {name:'Reena',emoji:heroAvatarHtml('hero3f6'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
