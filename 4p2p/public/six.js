...
const ALL_AVATAR_KEYS = [...Array.from({length:50}, (_,i) => 'hero3f'+(i+1)), ...Array.from({length:50}, (_,i) => 'hero3m'+(i+1))];
...
const ALL_BOT_AVATARS_6P = [
  ...
  {name:'Bijoy',emoji:heroAvatarHtml('hero3m1'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  ...
  {name:'Cyriac',emoji:heroAvatarHtml('hero3m2'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Davis',emoji:heroAvatarHtml('hero3m3'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Betty',emoji:heroAvatarHtml('hero3f26'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Ebin',emoji:heroAvatarHtml('hero3m4'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Fenil',emoji:heroAvatarHtml('hero3m5'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Gibin',emoji:heroAvatarHtml('hero3m6'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  ...
  {name:'Hillary',emoji:heroAvatarHtml('hero3m7'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Fiona',emoji:heroAvatarHtml('hero3f29'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Ittoop',emoji:heroAvatarHtml('hero3m8'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  ...
  {name:'Jaison',emoji:heroAvatarHtml('hero3m9'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  ...
  {name:'Kurian',emoji:heroAvatarHtml('hero3m10'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Lijo',emoji:heroAvatarHtml('hero3m11'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Kavya',emoji:heroAvatarHtml('hero3f34'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Mathew',emoji:heroAvatarHtml('hero3m12'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Leena',emoji:heroAvatarHtml('hero3f35'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Ninan',emoji:heroAvatarHtml('hero3m13'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  ...
  {name:'Oliver',emoji:heroAvatarHtml('hero3m14'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'}
];
