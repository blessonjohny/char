...
const ALL_BOT_AVATARS_6P = [
  ...
  {name:'Ajai',emoji:heroAvatarHtml('toon51'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Alok',emoji:heroAvatarHtml('toon52'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Anup',emoji:heroAvatarHtml('toon53'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Anjali',emoji:heroAvatarHtml('toon2'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Appu',emoji:heroAvatarHtml('toon54'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Arun',emoji:heroAvatarHtml('toon55'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Meera',emoji:heroAvatarHtml('toon3'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Benson',emoji:heroAvatarHtml('toon56'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Neha',emoji:heroAvatarHtml('toon6'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Binchu',emoji:heroAvatarHtml('toon57'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Charlie',emoji:heroAvatarHtml('toon58'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Jerin',emoji:heroAvatarHtml('toon59'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Priya',emoji:heroAvatarHtml('toon5'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Johny',emoji:heroAvatarHtml('toon60'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Reena',emoji:heroAvatarHtml('toon4'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Koshy',emoji:heroAvatarHtml('toon61'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Nate',emoji:heroAvatarHtml('toon62'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Divya',emoji:heroAvatarHtml('toon7'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Peter',emoji:heroAvatarHtml('toon63'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Lakshmi',emoji:heroAvatarHtml('toon8'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Rahul',emoji:heroAvatarHtml('toon64'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Rajesh',emoji:heroAvatarHtml('toon65'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Randall',emoji:heroAvatarHtml('toon66'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Sarah',emoji:heroAvatarHtml('toon9'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Renji',emoji:heroAvatarHtml('toon67'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Roji',emoji:heroAvatarHtml('toon68'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Nisha',emoji:heroAvatarHtml('toon10'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Roney',emoji:heroAvatarHtml('toon69'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Sanjay',emoji:heroAvatarHtml('toon70'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Shyam',emoji:heroAvatarHtml('toon71'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Deepa',emoji:heroAvatarHtml('toon11'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Stev',emoji:heroAvatarHtml('toon72'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Vinod',emoji:heroAvatarHtml('toon73'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Wesley',emoji:heroAvatarHtml('toon74'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Elsa',emoji:heroAvatarHtml('toon12'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Abin',emoji:heroAvatarHtml('toon75'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Maya',emoji:heroAvatarHtml('toon13'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Bibin',emoji:heroAvatarHtml('toon76'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Sherin',emoji:heroAvatarHtml('toon14'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Cibin',emoji:heroAvatarHtml('toon77'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Denny',emoji:heroAvatarHtml('toon78'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Eldho',emoji:heroAvatarHtml('toon79'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Teena',emoji:heroAvatarHtml('toon15'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Frankie',emoji:heroAvatarHtml('toon80'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'George',emoji:heroAvatarHtml('toon51'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Anu',emoji:heroAvatarHtml('toon16'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Hari',emoji:heroAvatarHtml('toon52'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Ivan',emoji:heroAvatarHtml('toon53'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Reshma',emoji:heroAvatarHtml('toon17'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Jibin',emoji:heroAvatarHtml('toon54'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Kevin',emoji:heroAvatarHtml('toon55'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Libin',emoji:heroAvatarHtml('toon56'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Jisha',emoji:heroAvatarHtml('toon18'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Manoj',emoji:heroAvatarHtml('toon57'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Nibin',emoji:heroAvatarHtml('toon58'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Oommen',emoji:heroAvatarHtml('toon59'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Nimmy',emoji:heroAvatarHtml('toon19'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Pauly',emoji:heroAvatarHtml('toon60'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Robin',emoji:heroAvatarHtml('toon61'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Beena',emoji:heroAvatarHtml('toon20'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Sibin',emoji:heroAvatarHtml('toon62'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Tibin',emoji:heroAvatarHtml('toon63'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Unni',emoji:heroAvatarHtml('toon64'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Soumya',emoji:heroAvatarHtml('toon21'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Vishnu',emoji:heroAvatarHtml('toon65'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Wilson',emoji:heroAvatarHtml('toon66'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Liya',emoji:heroAvatarHtml('toon22'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Xavier',emoji:heroAvatarHtml('toon67'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Yohan',emoji:heroAvatarHtml('toon68'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Merin',emoji:heroAvatarHtml('toon23'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Zachariah',emoji:heroAvatarHtml('toon69'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Aby',emoji:heroAvatarHtml('toon70'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Bijoy',emoji:heroAvatarHtml('toon71'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Asha',emoji:heroAvatarHtml('toon24'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Anita',emoji:heroAvatarHtml('toon25'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Cyriac',emoji:heroAvatarHtml('toon72'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Davis',emoji:heroAvatarHtml('toon73'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Betty',emoji:heroAvatarHtml('toon26'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Ebin',emoji:heroAvatarHtml('toon74'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Fenil',emoji:heroAvatarHtml('toon75'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Gibin',emoji:heroAvatarHtml('toon76'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Celine',emoji:heroAvatarHtml('toon27'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Diya',emoji:heroAvatarHtml('toon28'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Hillary',emoji:heroAvatarHtml('toon77'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Fiona',emoji:heroAvatarHtml('toon29'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Ittoop',emoji:heroAvatarHtml('toon78'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Gracy',emoji:heroAvatarHtml('toon30'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Hema',emoji:heroAvatarHtml('toon31'),bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Jaison',emoji:heroAvatarHtml('toon79'),bg:'linear-gradient(135deg,#4a90d9,#2a5a9a)'},
  {name:'Indu',emoji:heroAvatarHtml('toon32'),bg:'linear-gradient(135deg,#f0932b,#c26e0f)'},
  {name:'Jessy',emoji:heroAvatarHtml('toon33'),bg:'linear-gradient(135deg,#00cec9,#00a8a3)'},
  {name:'Kurian',emoji:heroAvatarHtml('toon80'),bg:'linear-gradient(135deg,#e84393,#c2266f)'},
  {name:'Lijo',emoji:heroAvatarHtml('toon51'),bg:'linear-gradient(135deg,#6c5ce7,#4834b0)'},
  {name:'Kavya',emoji:heroAvatarHtml('toon34'),bg:'linear-gradient(135deg,#fdcb6e,#e0a83c)'},
  {name:'Mathew',emoji:heroAvatarHtml('toon52'),bg:'linear-gradient(135deg,#00a8ff,#0077b3)'},
  {name:'Leena',emoji:heroAvatarHtml('toon35'),bg:'linear-gradient(135deg,#ff8fab,#e0648a)'},
  {name:'Ninan',emoji:heroAvatarHtml('toon53'),bg:'linear-gradient(135deg,#e17055,#c44536)'},
  {name:'Mariya',emoji:heroAvatarHtml('toon36'),bg:'linear-gradient(135deg,#00b894,#00a085)'},
  {name:'Babi',emoji:heroAvatarHtml('toon36'),bg:'linear-gradient(135deg,#c2266f,#8e1c52)'},
  {name:'Oliver',emoji:heroAvatarHtml('toon54'),bg:'linear-gradient(135deg,#8e44ad,#6c3483)'}
];
