...
const ALL_BOT_AVATARS_6P = [
  ...
  // These four (Rahul, Meera, Sanjay, Vinod) were genuine gaps -- every
  // one of them can actually be assigned to a bot (they're in the
  // server's own botNamePool arrays), but had no entry here at all,
  // meaning the lookup silently fell through to a same wrong-avatar
  // bug as the earlier Rebee/dolphin issue. Found by directly
  // cross-referencing every bot name pool against this list rather than
  // waiting to spot each one individually.
  {name:'Rahul',emoji:'<img src="/images/hero-avatars/men6.png" class="hero-avatar-face hero-avatar-normal" alt=""><img src="/images/hero-avatars/men6_sad.png" class="hero-avatar-face hero-avatar-sad" alt="">',bg:'linear-gradient(135deg,#e74c3c,#c0392b)'},
  {name:'Meera',emoji:'<img src="/images/hero-avatars/ladies3.png" class="hero-avatar-face hero-avatar-normal" alt=""><img src="/images/hero-avatars/ladies3_sad.png" class="hero-avatar-face hero-avatar-sad" alt="">',bg:'linear-gradient(135deg,#8e44ad,#6c3483)'},
  {name:'Sanjay',emoji:'<img src="/images/hero-avatars/men5.png" class="hero-avatar-face hero-avatar-normal" alt=""><img src="/images/hero-avatars/men5_sad.png" class="hero-avatar-face hero-avatar-sad" alt="">',bg:'linear-gradient(135deg,#1abc9c,#16a085)'},
  {name:'Vinod',emoji:'<img src="/images/hero-avatars/men9.png" class="hero-avatar-face hero-avatar-normal" alt=""><img src="/images/hero-avatars/men9_sad.png" class="hero-avatar-face hero-avatar-sad" alt="">',bg:'linear-gradient(135deg,#9b59b6,#8e44ad)'},
